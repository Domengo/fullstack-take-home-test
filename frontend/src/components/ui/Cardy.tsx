...
//   isFavorite: boolean;
//   toggleFavorite: () => void;
//   // toggleFavorite: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void; 
// }) => {
      ...
      <Card sx={{ maxWidth: 345, height: { xs: 300, sm: 350, md: 400 }, position: "relative", boxShadow: 3 }}>
        <CardActionArea sx={{ height: "100%" }}>
          <CardMedia
            ...
            image={coverPhotoURL}
            alt={title}
            sx={{ objectFit: "cover", height: "100%", position: "relative", zIndex: "auto" }}
          />
          <Box
            sx={{
              position: "absolute",
          ...
          />
          <CardContent sx={{ position: "absolute", bottom: 2, display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: "tooltip", color: "white" }}>
            <Tooltip title="title">
              <Typography variant="body2" gutterBottom>
                {title}
              </Typography>
        ...
        <CardActions sx={{ position: "absolute", right: "10px", top: "10px", zIndex: 2 }}>
          <Tooltip title="add to reading list">
            <IconButton
              aria-label="favorite"
              onClick={(e) => {
